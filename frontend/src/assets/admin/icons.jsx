/* Minimal inline SVG icon set (mirrors lucide-react glyphs) */
const base = {
  width: 18,
  height: 18,
  viewBox: '0 0 24 24',
...
const make = (size) => ({ ...base, width: size, height: size })

export const UserPlus = ({ size = 18 }) => (
  <svg {...make(size)}>
...
export const Edit2 = ({ size = 13 }) => (
  <svg {...make(size)}>
    <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" />
  </svg>
)

export const Trash2 = ({ size = 13 }) => (
  <svg {...make(size)}>
...
export const FileImage = ({ size = 15 }) => (
  <svg {...make(size)}>
